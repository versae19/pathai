...
export const TENTH_CATALOGUE = [
  {
    ...
    careers: [
      { name: 'Software Engineer', stream: 'Science (PCM)', exams: ['JEE Main', 'BITSAT'], salary: '₹5–30 LPA', desc: 'Build apps, websites, and systems that power the digital world.' },
      { name: 'Mechanical Engineer', stream: 'Science (PCM)', exams: ['JEE Main', 'GATE'], salary: '₹4–15 LPA', desc: 'Design machines, engines, and manufacturing systems for every industry.' },
      { name: 'Civil Engineer', stream: 'Science (PCM)', exams: ['JEE Main', 'GATE'], salary: '₹4–12 LPA', desc: 'Plan and build roads, bridges, buildings, and urban infrastructure.' },
      { name: 'Electrical Engineer', stream: 'Science (PCM)', exams: ['JEE Main', 'GATE'], salary: '₹5–14 LPA', desc: 'Work on power grids, circuits, and electrical equipment at scale.' },
      { name: 'Computer Science Engineer', stream: 'Science (PCM)', exams: ['JEE Main', 'BITSAT'], salary: '₹6–30 LPA', desc: 'Specialize in algorithms, AI, data systems, and network architecture.' },
      { name: 'Aerospace Engineer', stream: 'Science (PCM)', exams: ['JEE Main', 'IIST Admission'], salary: '₹6–20 LPA', desc: 'Design aircraft and spacecraft — work with ISRO, DRDO, or HAL.' },
      { name: 'Robotics Engineer', stream: 'Science (PCM/PCMB)', exams: ['JEE Main', 'JEE Advanced'], salary: '₹6–22 LPA', desc: 'Design and program robots for industry, healthcare, and research.' },
      { name: 'Biomedical Engineer', stream: 'Science (PCMB)', exams: ['JEE Main', 'CUET'], salary: '₹4–15 LPA', desc: 'Build medical devices, prosthetics, and diagnostic equipment.' },
      { name: 'Environmental Engineer', stream: 'Science (PCM)', exams: ['JEE Main', 'GATE'], salary: '₹4–12 LPA', desc: 'Solve pollution, waste management, and climate engineering challenges.' },
      { name: 'Chemical Engineer', stream: 'Science (PCM)', exams: ['JEE Main', 'GATE'], salary: '₹5–16 LPA', desc: 'Design industrial processes that turn raw materials into useful products.' },
      { name: 'Electronics & Comm. Engineer', stream: 'Science (PCM)', exams: ['JEE Main', 'GATE'], salary: '₹4–18 LPA', desc: 'Design chips, telecom systems, and embedded electronic devices.' },
      { name: 'Petroleum Engineer', stream: 'Science (PCM)', exams: ['JEE Main', 'ONGC Recruitment'], salary: '₹8–25 LPA', desc: 'Work in oil & gas exploration with companies like ONGC and BPCL.' },
    ],
  },
  {
    id: 'medical',
    ...
    careers: [
      { name: 'Doctor (MBBS)', stream: 'Science (PCB)', exams: ['NEET-UG'], salary: '₹6–50+ LPA', desc: 'Diagnose and treat patients — the most respected healthcare profession in India.' },
      { name: 'Dentist (BDS)', stream: 'Science (PCB)', exams: ['NEET-UG'], salary: '₹4–20 LPA', desc: 'Specialize in oral health, dental surgery, and orthodontics.' },
      ...
      { name: 'Nurse (BSc Nursing)', stream: 'Science (PCB)', exams: ['AIIMS BSc Nursing', 'JIPMER Nursing'], salary: '₹3–10 LPA', desc: 'Provide direct patient care in hospitals, clinics, and home settings.' },
      ...
      { name: 'Veterinarian (BVSc)', stream: 'Science (PCB)', exams: ['ICAR-AIEEA'], salary: '₹4–15 LPA', desc: 'Treat animals and work in husbandry, wildlife conservation, and research.' },
  ...
  },
  {
    ...
    careers: [
      { name: 'Chartered Accountant (CA)', stream: 'Commerce', exams: ['CA Foundation', 'CA Intermediate', 'CA Final'], salary: '₹7–30+ LPA', desc: 'The gold standard of Indian accounting — auditing, taxation, and advisory.' },
      { name: 'Company Secretary (CS)', stream: 'Commerce', exams: ['CS Foundation', 'CS Executive', 'CS Professional'], salary: '₹5–20 LPA', desc: 'Ensure corporate legal compliance and governance in companies.' },
  ...
  },
  {
    ...
    careers: [
      ...
      { name: 'Lawyer / Advocate', stream: 'Any (Humanities ideal)', exams: ['CLAT', 'AILET'], salary: '₹4–50+ LPA', desc: 'Represent clients in court and draft contracts, laws, and agreements.' },
  ...
  },
  {
    ...
    careers: [
      ...
      { name: 'Animation & VFX Artist', stream: 'Any (tech advantage)', exams: ['MAAC / Arena Animation', 'NID DAT'], salary: '₹4–18 LPA', desc: 'Create CGI and visual effects for films, games, and streaming content.' },
      { name: 'Journalist / News Reporter', stream: 'Any (Arts ideal)', exams: ['IIMC', 'AJK MCRC', 'State Mass Comm Entrance'], salary: '₹3–18 LPA', desc: 'Report news, investigate stories, and inform the public through media.' },
  ...
  },
  {
    ...
    careers: [
      { name: 'School Teacher', stream: 'Any', exams: ['CTET', 'State TET', 'B.Ed Entrance'], salary: '₹3–10 LPA', desc: 'Inspire future generations in primary or secondary school classrooms.' },
      ...
      { name: 'Psychologist / Counsellor', stream: 'Any (Arts/Science)', exams: ['CUET', 'State PG Entrance'], salary: '₹4–18 LPA', desc: 'Help people manage mental health, career choices, and personal challenges.' },
      { name: 'Social Worker / NGO Professional', stream: 'Any', exams: ['TISS Entrance', 'CUET'], salary: '₹3–12 LPA', desc: 'Drive community development and grassroots change through NGOs and government.' },
  ...
  },
  {
    ...
    careers: [
      ...
      { name: 'Cloud / DevOps Engineer', stream: 'Science (PCM)', exams: ['JEE Main', 'AWS / Azure Certifications'], salary: '₹6–28 LPA', desc: 'Build and manage cloud infrastructure powering apps used by millions.' },
...
const PCM_CATEGORIES = [
  {
    ...
    careers: [
      ...
      { name: 'Electronics & Comm. Engineer', stream: 'B.Tech ECE — 4 years', exams: ['JEE Main', 'BITSAT'], salary: '₹4–18 LPA', desc: 'Design communication networks, embedded systems, and semiconductor chips.' },
      ...
      { name: 'Robotics / Mechatronics Engineer', stream: 'B.Tech Robotics/Mechatronics — 4 years', exams: ['JEE Main', 'JEE Advanced'], salary: '₹6–22 LPA', desc: 'Build intelligent machines combining mechanics, electronics, and software.' },
      ...
      { name: 'Petroleum / Mining Engineer', stream: 'B.Tech Petroleum/Mining — 4 years', exams: ['JEE Main', 'ONGC Recruitment'], salary: '₹8–25 LPA', desc: 'Work in oil, gas, and mineral extraction with ONGC and private firms.' },
    ],
  },
  {
    ...
    careers: [
      { name: 'Architect (B.Arch)', stream: 'B.Arch — 5 years', exams: ['JEE Paper 2 (B.Arch)', 'NATA'], salary: '₹4–20 LPA', desc: 'Design buildings and urban spaces — PCM is required for B.Arch at IITs/NITs.' },
      ...
      { name: 'UI/UX / Product Designer', stream: 'B.Des Product Design — 4 years', exams: ['UCEED', 'NID DAT'], salary: '₹5–22 LPA', desc: 'Design intuitive digital products and interfaces used by millions.' },
      { name: 'Industrial Designer', stream: 'B.Des Industrial Design — 4 years', exams: ['NID DAT', 'UCEED'], salary: '₹5–18 LPA', desc: 'Design physical products — from consumer electronics to vehicles.' },
  ...
  },
  {
    ...
    careers: [
      ...
      { name: 'Data Scientist / ML Engineer', stream: 'B.Tech CS / B.Sc Maths → Data Science', exams: ['JEE Main', 'CUET'], salary: '₹6–30 LPA', desc: 'Build AI models and extract insights from datasets using Python and ML.' },
  ...
  },
  {
    ...
    careers: [
      { name: 'Indian Army Officer (NDA)', stream: 'NDA → 3-year training at Pune', exams: ['NDA Exam (UPSC)', 'SSB Interview'], salary: '₹7–20 LPA + perks', desc: 'Join the Army as a commissioned officer directly after Class 12 via NDA.' },
      { name: 'Indian Air Force Pilot (NDA)', stream: 'NDA → Air Force (PCM mandatory)', exams: ['NDA Exam (UPSC)', 'PABT + CPSS Test', 'SSB Interview'], salary: '₹7–20 LPA + perks', desc: 'Fly fighter jets or serve in technical branches — PCM is required.' },
      { name: 'Indian Navy Officer (NDA)', stream: 'NDA → Naval Wing (PCM mandatory)', exams: ['NDA Exam (UPSC)', 'SSB Interview'], salary: '₹7–18 LPA + perks', desc: 'Command naval vessels and work in marine technical operations.' },
      { name: 'AFCAT Officer (Air Force)', stream: 'B.Tech/B.Sc → AFCAT', exams: ['AFCAT Exam', 'SSB Interview'], salary: '₹7–20 LPA + perks', desc: 'Join Air Force in flying, technical, or ground duty after graduation.' },
    ],
  },
  {
    id: 'diploma-pcm',
...
const PCB_CATEGORIES = [
  {
    ...
    interests: ['healthcare', 'science'],
    careers: [
      { name: 'Doctor (MBBS)', stream: 'MBBS — 5.5 years (incl. internship)', exams: ['NEET-UG'], salary: '₹6–50+ LPA', desc: 'Become a doctor via MBBS at a government or private medical college.' },
      { name: 'Dentist (BDS)', stream: 'BDS — 5 years', exams: ['NEET-UG'], salary: '₹4–20 LPA', desc: 'Specialize in oral health, dental surgery, and orthodontics.' },
      ...
      { name: 'Veterinarian (BVSc)', stream: 'BVSc & AH — 5 years', exams: ['ICAR-AIEEA'], salary: '₹4–15 LPA', desc: 'Treat animals and work in livestock management, wildlife, and food safety.' },
    ],
  },
  {
    ...
    interests: ['healthcare'],
    careers: [
      { name: 'BSc Nursing', stream: 'BSc Nursing — 4 years', exams: ['AIIMS BSc Nursing', 'JIPMER Nursing', 'State Nursing Entrance'], salary: '₹3–10 LPA', desc: 'Direct patient care role with strong demand in India and for overseas nursing jobs.' },
      { name: 'Physiotherapist (BPT)', stream: 'BPT — 4.5 years', exams: ['NEET-UG (some states)', 'State BPT Entrance'], salary: '₹3–12 LPA', desc: 'Rehabilitate patients with physical therapy, sports injuries, and neurological cases.' },
      { name: 'Pharmacist (B.Pharm)', stream: 'B.Pharm — 4 years', exams: ['GPAT', 'State Pharmacy Entrance'], salary: '₹3–12 LPA', desc: 'Develop and dispense medicines — work in hospitals, retail chains, and R&D labs.' },
      { name: 'Medical Lab Technologist (BMLT)', stream: 'BMLT — 3 years', exams: ['CUET', 'State Paramedical Entrance'], salary: '₹3–10 LPA', desc: 'Perform blood tests, biopsies, and diagnostics in hospitals and pathology labs.' },
      { name: 'Radiographer (BSc Radiology)', stream: 'BSc Medical Imaging / Radiology — 3 years', exams: ['CUET', 'State Entrance'], salary: '₹4–15 LPA', desc: 'Operate MRI, CT, and X-ray machines for patient diagnosis.' },
      { name: 'Optometrist (B.Optom)', stream: 'B.Optom — 4 years', exams: ['State Optometry Entrance'], salary: '₹3–8 LPA', desc: 'Diagnose and treat vision disorders and prescribe corrective lenses.' },
      ...
      { name: 'Dietitian / Clinical Nutritionist', stream: 'BSc Nutrition & Dietetics — 3 years', exams: ['CUET', 'State Entrance'], salary: '₹3–10 LPA', desc: 'Plan therapeutic diets for hospital patients and wellness clients.' },
    ],
  },
  {
    id: 'bsc-life-pcb',
  ...
  },
  {
    ...
    interests: ['science'],
    careers: [
      { name: 'Agricultural Scientist (BSc Ag)', stream: 'BSc Agriculture — 4 years', exams: ['ICAR-AIEEA'], salary: '₹4–15 LPA', desc: 'Develop crop varieties and farming systems at ICAR, state agri-universities.' },
  ...
  },
  {
    ...
    interests: ['government'],
    careers: [
      { name: 'Indian Army Officer (NDA — General Duty)', stream: 'NDA → Army', exams: ['NDA Exam (UPSC)', 'SSB Interview'], salary: '₹7–20 LPA + perks', desc: 'Join the Army as a commissioned officer — PCB students eligible for non-tech arms.' },
...
const COMMERCE_CATEGORIES = [
  {
    ...
    interests: ['finance', 'business'],
    careers: [
      { name: 'Chartered Accountant (CA)', stream: 'CA Foundation → CA Intermediate → CA Final', exams: ['CA Foundation', 'CA Intermediate', 'CA Final'], salary: '₹7–30+ LPA', desc: "India's gold standard accounting credential — audit, taxation, and advisory." },
      { name: 'Company Secretary (CS)', stream: 'CS Foundation → CS Executive → CS Professional', exams: ['CS Foundation', 'CS Executive', 'CS Professional'], salary: '₹5–20 LPA', desc: 'Ensure corporate compliance, governance, and legal secretarial work.' },
  ...
  },
  {
    ...
    careers: [
      ...
      { name: 'Hotel Management (BHM)', stream: 'BHM — 3–4 years', exams: ['NCHM JEE', 'IHM State Entrance'], salary: '₹5–25 LPA', desc: 'Build a global career in luxury hospitality, cruise lines, and resort management.' },
  ...
  },
  {
    ...
    careers: [
      ...
      { name: 'Stock Broker / Equity Analyst', stream: 'B.Com / BBA + NISM Certifications', exams: ['NISM Certifications', 'CFA Exams'], salary: '₹4–25 LPA', desc: 'Trade securities and research stocks for individuals and institutions.' },
    ],
  },
  {
    id: 'law-commerce',
    ...
    careers: [
      { name: 'Corporate Lawyer (BA LLB)', stream: 'BA LLB / BBA LLB — 5 years', exams: ['CLAT', 'AILET', 'LSAT India'], salary: '₹6–50+ LPA', desc: 'Commerce background gives a huge advantage in corporate, tax, and banking law.' },
      { name: 'Tax Lawyer (CA + LLB)', stream: 'LLB alongside CA qualification', exams: ['CLAT', 'CA Foundation'], salary: '₹8–40 LPA', desc: 'Combine CA and LLB for high-value tax and regulatory advisory work.' },
      { name: 'Judiciary / Civil Judge', stream: 'BA LLB → Judicial Services Exam', exams: ['Judicial Services Exam'], salary: '₹10–30 LPA', desc: 'Adjudicate civil and criminal cases at district and session courts.' },
    ],
  },
  {
  ...
  },
  {
    ...
    interests: ['government'],
    careers: [
      { name: 'IAS / IPS Officer', stream: 'B.Com / BBA → UPSC Civil Services', exams: ['UPSC Civil Services'], salary: '₹8–20 LPA', desc: 'Commerce graduates are fully eligible for UPSC — choose Economics or Commerce as optional.' },
      { name: 'SSC CGL Officer (Income Tax / GST)', stream: 'Any graduation', exams: ['SSC CGL'], salary: '₹5–12 LPA', desc: 'Join Income Tax, Enforcement Directorate, or GST departments.' },
      { name: 'IBPS / RBI Banking Exam', stream: 'B.Com / BBA', exams: ['IBPS PO', 'RBI Grade B', 'NABARD'], salary: '₹6–16 LPA', desc: 'Join nationalised banks, RBI, or NABARD in officer-grade positions.' },
    ],
  },
  {
    ...
    careers: [
      ...
      { name: 'E-commerce / D2C Brand Manager', stream: 'BBA / B.Com + Digital Skills', exams: ['No formal exam'], salary: '₹4–20 LPA', desc: 'Sell products via your own brand or established marketplaces like Flipkart/Amazon.' },
      { name: 'Digital Marketer', stream: 'BBA / B.Com + Certifications', exams: ['Google / Meta / HubSpot Certifications (free)'], salary: '₹4–18 LPA', desc: 'Grow brands through SEO, paid ads, social media, and email campaigns.' },
      { name: 'Product Manager (MBA path)', stream: 'BBA / B.Tech → MBA at IIM/ISB', exams: ['IPMAT', 'CAT / GMAT'], salary: '₹10–40 LPA', desc: "Own a product's strategy and roadmap at a tech company or startup." },
    ],
  },
]
...
const ARTS_CATEGORIES = [
  {
    ...
    interests: ['government'],
    careers: [
      { name: 'Lawyer / Advocate (BA LLB)', stream: 'BA LLB — 5 years', exams: ['CLAT', 'AILET', 'LSAT India'], salary: '₹4–50+ LPA', desc: 'Arts/Humanities is the ideal base for law — strong demand in litigation and corporate law.' },
      { name: 'Constitutional / Human Rights Lawyer', stream: 'BA LLB specialising in Constitutional Law', exams: ['CLAT', 'AILET'], salary: '₹5–30 LPA', desc: 'Argue fundamental rights at high courts and Supreme Court.' },
      { name: 'Judiciary / Civil Judge', stream: 'BA LLB → Judicial Services Exam', exams: ['Judicial Services Exam (state)'], salary: '₹10–30 LPA', desc: 'Adjudicate civil and criminal cases at district courts.' },
      { name: 'Corporate Lawyer', stream: 'BA LLB / BBA LLB — 5 years', exams: ['CLAT', 'AILET'], salary: '₹8–50 LPA', desc: 'Draft contracts, handle M&A deals, and advise corporations on legal strategy.' },
    ],
  },
  {
    ...
    careers: [
      ...
      { name: 'IFS Officer (Foreign Service)', stream: 'BA History / International Relations → UPSC', exams: ['UPSC Civil Services'], salary: '₹8–20 LPA', desc: 'Represent India abroad as a diplomat — Humanities is the strongest base.' },
  ...
  },
  {
    ...
    careers: [
      { name: 'Journalist / News Reporter', stream: 'BA Journalism / BJMC — 3 years', exams: ['IIMC Entrance', 'AJK MCRC Entrance', 'State Mass Comm Entrance'], salary: '₹3–18 LPA', desc: 'Report news for print, TV, digital, and radio newsrooms.' },
      { name: 'News Anchor / TV Presenter', stream: 'BJMC / BA Journalism + Media Training', exams: ['IIMC', 'FTII', 'Agency Auditions'], salary: '₹4–25 LPA', desc: 'Present news, host shows, and anchor live events on national television.' },
      { name: 'Content Writer / Author', stream: 'BA English / Mass Communication — 3 years', exams: ['No formal entrance — portfolio-based'], salary: '₹3–15 LPA', desc: 'Write and edit content for brands, publishers, and digital platforms.' },
      ...
      { name: 'Advertising / PR Professional', stream: 'BA Mass Comm / MICA — 3 years', exams: ['MICA Entrance (MICAT)', 'XIC Entrance'], salary: '₹4–20 LPA', desc: 'Create brand campaigns and manage public relations for companies.' },
    ],
  },
  {
    ...
    careers: [
      { name: 'Psychologist / Counsellor', stream: 'BA / BSc Psychology — 3 years', exams: ['CUET', 'DU / Central University Entrance'], salary: '₹4–18 LPA', desc: 'Help people manage mental health, career choices, and personal challenges.' },
      { name: 'Sociologist / Social Researcher', stream: 'BA Sociology — 3 years', exams: ['CUET', 'JNU Entrance'], salary: '₹4–15 LPA', desc: 'Study social behaviour and institutions for policy, NGO, and academic work.' },
      ...
      { name: 'Political Scientist / Policy Analyst', stream: 'BA Political Science — 3 years', exams: ['CUET', 'JNU Entrance', 'TISS Entrance'], salary: '₹5–20 LPA', desc: 'Work at think tanks, political parties, or government advisory bodies.' },
  ...
  },
  {
    ...
    careers: [
      ...
      { name: 'Graphic Designer / Illustrator', stream: 'BFA / NID / NIFT — 4 years', exams: ['NID DAT', 'NIFT Entrance', 'UCEED'], salary: '₹3–15 LPA', desc: 'Create visual content for brands, publishers, and media houses.' },
      { name: 'Fashion Designer (NIFT)', stream: 'B.Des Fashion Design — 4 years', exams: ['NIFT Entrance', 'NID DAT'], salary: '₹4–20 LPA', desc: 'Design clothing and accessories — Arts students have a natural head start.' },
      { name: 'Musician / Vocalist', stream: 'BA / BPA Music — 3–4 years', exams: ['Gandharva Mahavidyalaya', 'Sangeet Natak Akademi Exams'], salary: '₹3–Unlimited', desc: 'Pursue classical, Bollywood, or independent music professionally.' },
    ],
  },
  {
    id: 'education-arts',
    ...
    interests: ['education'],
    careers: [
      { name: 'School Teacher (B.Ed)', stream: 'BA + B.Ed (3+2 or 4-year integrated BEd)', exams: ['CTET', 'State TET', 'B.Ed Entrance'], salary: '₹3–10 LPA', desc: 'Teach History, Geography, Civics, or Languages at schools.' },
      { name: 'College Lecturer / Professor', stream: 'BA + MA + UGC NET', exams: ['UGC NET', 'SET'], salary: '₹5–20 LPA', desc: 'Teach Humanities at college level and pursue academic research.' },
      { name: 'Social Worker / NGO Professional', stream: 'BA Social Work / TISS — 3 years', exams: ['TISS Entrance', 'CUET'], salary: '₹3–12 LPA', desc: 'Drive community development and grassroots change at NGOs and government.' },
      { name: 'Educational Psychologist', stream: 'BA Psychology + MA Psychology', exams: ['CUET', 'State PG Entrance'], salary: '₹4–15 LPA', desc: 'Assess learning difficulties and support student wellbeing in schools.' },
    ],
  },
  {
    id: 'languages-arts',
...
const VOCATIONAL_CATEGORIES = [
  ...
  },
  {
    ...
    interests: ['business', 'creative'],
    careers: [
      { name: 'Hotel Management (NCHM JEE)', stream: 'BHM / Diploma Hotel Management — 3–4 years', exams: ['NCHM JEE', 'State IHM Entrance'], salary: '₹3–20 LPA', desc: 'Build a career in luxury hospitality, cruise lines, and resort management.' },
      { name: 'Chef / Culinary Arts', stream: 'Diploma Culinary Arts (IHM) — 1–3 years', exams: ['NCHM JEE', 'State IHM Entrance'], salary: '₹3–20 LPA', desc: 'Create cuisine in top hotels, restaurants, and as an independent food professional.' },
      { name: 'Event Manager / Planner', stream: 'BHM / Event Management Degree', exams: ['Hotel Management Entrance'], salary: '₹3–15 LPA', desc: 'Plan and execute weddings, corporate events, and large-scale conferences.' },
  ...
  },
  {
    ...
    careers: [
      ...
      { name: 'Fitness Trainer / Yoga Instructor', stream: 'Fitness Certification / Yoga Diploma', exams: ['QCI Yoga Cert', 'ACE / ISSA Fitness Certification'], salary: '₹3–15 LPA', desc: 'Train clients at gyms, yoga studios, and corporate wellness programmes.' },
    ],
  },
]
